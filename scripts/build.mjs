...
function renderHome(page) {
  ...
  const heroMedia = video
    ? '<img class="home-hero-media__poster" src="' + attr(poster) + '" alt="" width="1920" height="1080" decoding="async" fetchpriority="high"' + cwEdit(rk, 'hero-poster-img', 'Hero poster image', 'img') + '><video class="home-hero-media__video" autoplay muted loop playsinline preload="none"' + cwEdit(rk, 'hero-poster', 'Hero video poster', 'poster') + ' poster="' + attr(poster) + '" data-cw-hero-video data-cw-lazy-src="' + attr(video) + '"></video>'
    : '<img class="home-hero-media__poster"' + cwEdit(rk, 'hero-poster-img', 'Hero image', 'img') + ' src="' + attr(poster) + '" alt="Clearwater Dentist office" width="1920" height="1080" loading="eager" decoding="async" fetchpriority="high">';
